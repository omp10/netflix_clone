...
export default function HomeScreen() {
  ...
  // Get contentType from Zustand store
    ...
    <>
      <div className="relative h-screen text-white">
        ...
        <img
          ...
          alt={trendingContent?.title || trendingContent?.name || 'Background'}
          className="absolute top-0 w-full h-full object-cover -z-50"
          onLoad={() => setImgLoading(false)}
        />
        <div className="absolute top-0 left-0 w-full bg-black/50 -z-50" aria-hidden="true" />
